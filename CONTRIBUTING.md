...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------|
| **v1.2.1-beta** | Docker wrapper added                                                                                                                                                                                                                                                                                | Pre-release |
...
| **v1.1.0-beta** | Image samples replaced with CC BY-NC 4.0 licensed images from various sources, data-processing scripts were finalized with their own unit tests and wide-scale adaptation of the CLI flags for input-output arguments                                                                               | Pre-release |
