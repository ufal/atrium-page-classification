...
def split_csv_and_aggregate(input_file):
    # Configuration
    output_dir = './per_document/'
    ...
    try:
        ...
        print("Done! Check the './per_document/' folder.")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python split_by_file.py <your_file.csv>")
    else:
        split_csv_and_aggregate(sys.argv[1])
