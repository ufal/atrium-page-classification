 ...
 * The response body carries only {type, predictions|pages} — the uploaded
 * file name is known client-side and passed in explicitly.
 */
function renderResults(data, fileName) {
    ...
    let html = `<h3>Results for: ${fileName || 'Uploaded File'}</h3>`;
    ...
    if (form) {
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                renderResults(data, file && file.name);
